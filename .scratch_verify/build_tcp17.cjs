// 建立114TCPE17/114TCPJ17（金門縣）競賽模式版本，完全比照build_tcp14_16.cjs的既有慣例：
// BlocklyYdws維持mode:'contest'（稍後另一支腳本strip答案），blockly-lab維持mode:'learning'
// （quota考量既有政策，全平台已停用成績上傳，不會打Worker，本機testCases比對即可）。
const fs = require('fs');
...
const MAPPING = [
  { src: '114EKinmen', tcp: '114TCPE17' },
  { src: '114JKinmen', tcp: '114TCPJ17' },
];
