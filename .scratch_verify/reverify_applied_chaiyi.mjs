// 從「已經套用進課程檔案」的最終版114EChaiyi.js/114JChaiyi.js直接讀starterXml重新驗證，
// 確認apply_chaiyi_starterxml.cjs的字串替換沒有搞壞任何XML內容（跟tasks_chaiyi_*.json
// 的中繼驗證結果一致，屬於最終把關）。
...
const files = [
  '../../YDWS-CodingBank/courses/114EChaiyi.js',
  '../../YDWS-CodingBank/courses/114JChaiyi.js',
];
