// 組裝苗栗縣(114EMiaoli/114JMiaoli)兩個課程JS檔（學習模式，含starterXml範例答案），
...
const COURSES = [
  { code: '114EMiaoli', title: '114-苗栗縣國小', file: 'tasks_miaoli_e.json' },
  { code: '114JMiaoli', title: '114-苗栗縣國中', file: 'tasks_miaoli_j.json' },
];
