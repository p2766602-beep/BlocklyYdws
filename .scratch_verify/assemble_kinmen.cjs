// 組裝金門縣(114EKinmen/114JKinmen)兩個課程JS檔（學習模式，含starterXml範例答案），
...
const COURSES = [
  { code: '114EKinmen', title: '114-金門縣國小', file: 'tasks_kinmen_e.json' },
  { code: '114JKinmen', title: '114-金門縣國中', file: 'tasks_kinmen_j.json' },
];
