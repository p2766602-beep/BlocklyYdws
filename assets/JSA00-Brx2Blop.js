var e={code:`JSA00`,title:`基礎練習2`,type:`programming`,mode:`learning`,tasks:[{id:`A-08-0`,title:`查找最大值`,difficulty:`L2`,description:`老師進行成績統計，老師輸入每位同學的成績，請你寫一個程式找出最高分。
...
第二行輸入9 6 8三個數字序列
程式運算輸出最大值9`},{input:`6
99 12 129 16 8 3`,output:`129`,explanation:`第一行輸入6，表示有6個數字要輸入
第二行輸入99 12 129 16 8 3六個數字序列
程式運算輸出最大值129`}],testCases:[{input:`3
9 6 8`,expectedOutput:`9`,score:10},{input:`6
99 12 129 16 8 3`,expectedOutput:`129`,score:10},{input:`5
89 15 47 0 56`,expectedOutput:`89`,score:10},{input:`1
25`,expectedOutput:`25`,score:10}],starterXml:`<xml xmlns="https://developers.google.com/blockly/xml">
  <variables>
...
</xml>`},{id:`A-08-1`,title:`查找最大值、最小值`,difficulty:`L2`,description:`老師進行成績統計，老師輸入每位同學的成績，請你寫一個程式找出最高分及最低分。
輸入第一行是整數 N，代表有 N 筆成績
第二行輸入 N 個數字，數字間以空白間隔
程式輸出最大值及最小值。
...
9 6 8`,expectedOutput:`9 6`,score:10},{input:`6
99 12 129 16 8 3`,expectedOutput:`129 3`,score:10},{input:`5
89 15 47 0 56`,expectedOutput:`89 0`,score:10},{input:`1
25`,expectedOutput:`25 25`,score:10}],starterXml:``},{id:`A-09-0`,title:`判斷質數`,difficulty:`L3`,description:`質數是大於 1 且只能被 1 和自己整除的數字。
...
電腦運算判斷6可被2整除，不是質數
程式運算輸出No`}],testCases:[{input:`1`,expectedOutput:`No`,score:10},{input:`2`,expectedOutput:`Yes`,score:10},{input:`1007`,expectedOutput:`No`,score:10},{input:`997`,expectedOutput:`Yes`,score:10}],starterXml:`<xml xmlns="https://developers.google.com/blockly/xml">
  <variables>
    <variable id="var_n">N</variable>
    <variable id="var_i">i</variable>
...
</xml>`},{id:`A-09-1`,title:`找因數`,difficulty:`L3`,description:`因數是指一個整數能被另一整數「整除」時，這個「除數」就是「被除數」的因數。
...
程式輸出39所有因數1 3 13 39`}],testCases:[{input:`56`,expectedOutput:`1 2 4 7 8 14 28 56`,score:10},{input:`37`,expectedOutput:`1 37`,score:10},{input:`78`,expectedOutput:`1 2 3 6 13 26 39 78`,score:10},{input:`88`,expectedOutput:`1 2 4 8 11 22 44 88`,score:10}],starterXml:``},{id:`A-10-0`,title:`多科成績計算`,difficulty:`L3`,description:`小明參加了數學、英文、自然...等多科的段考，老師希望能快速算出總分與平均分數，並判斷是否及格。
...
第二行輸入80 70 90，經過計算後
總分240、平均80、及格`},{input:`6
50 41 60 55 70 65`,output:`341
57
不及格`,explanation:`第一行輸入6，表示後面會有6個數字輸入
第二行輸入50 41 60 55 70 65，經過計算後
程式輸出總分341、平均57、不及格`}],testCases:[{input:`3
20 60 90`,expectedOutput:`170 57 不及格`,score:10},{input:`6
50 41 60 55 70 65`,expectedOutput:`341 57 不及格`,score:10},{input:`5
80 70 75 85 90`,expectedOutput:`400 80 及格`,score:10},{input:`1
55`,expectedOutput:`55 55 不及格`,score:10}],starterXml:`<xml xmlns="https://developers.google.com/blockly/xml">
  <variables>
...
</xml>`},{id:`A-10-1`,title:`加權成績計算`,difficulty:`L4`,description:`大明綜合高中辦理考試，不同科系考試科目數量、每周上課時數不一定相同
...
55 90 99
2 3 3`,expectedOutput:`677 85 A`,score:10}],starterXml:``},{id:`A-11-0`,title:`計算字元出現次數`,difficulty:`L3`,description:`請設計程式，輸入一個字串，並輸入一個英文字母輸出該字母在字串中出現的次數。
...
o`,expectedOutput:`3`,score:10},{input:`chaiyicity
i`,expectedOutput:`3`,score:10},{input:`announcement
n`,expectedOutput:`4`,score:10},{input:`experimen
e`,expectedOutput:`3`,score:10}],starterXml:`<xml xmlns="https://developers.google.com/blockly/xml">
  <variables>
...
</xml>`},{id:`A-11-1`,title:`計算字元出現最多的次數`,difficulty:`L4`,description:`請設計程式，輸入一字串由小寫英文字母組合，長度1~50間的字串
...
程式運算，將字串往後移2個位置加密
程式輸出uvwfgpv`}],testCases:[{input:`goodmoning`,expectedOutput:`iqqfoqpkpi`,score:10},{input:`chaiyicity`,expectedOutput:`ejckakekva`,score:10},{input:`announcement`,expectedOutput:`cppqwpegogpv`,score:10},{input:`experimen`,expectedOutput:`gzrgtkogp`,score:10}],starterXml:`<xml xmlns="https://developers.google.com/blockly/xml">
  <variables>
...
</xml>`},{id:`A-12-1`,title:`動態密碼轉換`,difficulty:`L4`,description:`小明設計了一種英文字元密碼環編碼規則：
...
experimen`,expectedOutput:`experimen`,score:10}],starterXml:``},{id:`A-13-0`,title:`二數的最大公因數`,difficulty:`L3`,description:`小明上學時，不太會找最大公因數，請寫個程式幫他找一下
...
6`,expectedOutput:`6`,score:10},{input:`34
52`,expectedOutput:`2`,score:10},{input:`24
18`,expectedOutput:`6`,score:10},{input:`1
8`,expectedOutput:`1`,score:10}],starterXml:`<xml xmlns="https://developers.google.com/blockly/xml">
  <variables>
...
</xml>`},{id:`A-13-1`,title:`最大公因數`,difficulty:`L4`,description:`小明上學時，不太會找最大公因數，請寫個程式幫他找一下
...
8`,expectedOutput:`8`,score:10}],starterXml:``}]};export{e as JSA00};