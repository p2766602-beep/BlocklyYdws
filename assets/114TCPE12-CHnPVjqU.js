var e={code:`114TCPE12`,title:`114-臺北市國小（競賽模式）`,type:`programming`,mode:`learning`,description:`臺北市114學年度國小組資訊科技競賽練習題，涵蓋字串處理、不定長度輸入解析與行程長度編碼。`,tasks:[{id:`114TCPE12-1`,title:`崔老師的出缺席紀錄表`,problemTitle:`崔老師的出缺席紀錄表`,role:`contest`,difficulty:`L2`,blocklyFit:`高`,requiresGreenFlag:!0,description:`崔老師用二維清單記錄一週的出席狀況：
小明到到缺到到
小美到缺缺到到
說明：
每一列是一位學生
