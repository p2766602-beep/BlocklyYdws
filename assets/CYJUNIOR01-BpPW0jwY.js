...
第一道關卡是一扇巨大的電子鐵門。門鎖的螢幕上並沒有數字鍵盤，只有一串閃爍的、由 0 與 1 組成的符號序列。門邊的銘牌刻著一行字：「只有通曉機器語言的人，才能將二元的虛幻轉化為十進的真實。」這顯然是一個二進位轉十進位的謎題。請將螢幕上的二進位字串解碼為十進位數字，輸入系統以開啟大門。`,input:`第一行：一個字串 S（只包含 0 與 1）。`,output:`第一行：一個整數，代表轉換後的十進位數值。`},examples:[{input:`101`,output:`5`,explanation:`1x4 + 0x2 + 1x1 = 5`},{input:`1111`,output:`15`,explanation:`8 + 4 + 2 + 1 = 15`}],testCases:[{input:`10`,expectedOutput:`2`,output:`2`,score:10,hidden:!1},{input:`110`,expectedOutput:`6`,output:`6`,score:15,hidden:!1},{input:`1000`,expectedOutput:`8`,output:`8`,score:20,hidden:!1},{input:`11011`,expectedOutput:`27`,output:`27`,score:25,hidden:!1},{input:`1111101000`,expectedOutput:`1000`,output:`1000`,score:30,hidden:!1}],starterXml:`<xml xmlns="https://developers.google.com/blockly/xml">
  <variables>
...
50`,expectedOutput:`100`,output:`100`,score:30,hidden:!1}],starterXml:`<xml xmlns="https://developers.google.com/blockly/xml">
  <variables>
    <variable id="var_n">N</variable>
...
請你幫小明計算出所有可能的走法總數。`,input:`第一行：一個整數 N，代表樓梯的總階數。`,output:`第一行： 一個整數，代表走法的總數。`},examples:[{input:`3`,output:`3`,explanation:`走法：(1,1,1), (1,2), (2,1) 共 3 種。`},{input:`4`,output:`5`,explanation:`走法：(1,1,1,1), (1,1,2), (1,2,1), (2,1,1), (2,2) 共 5 種。`}],testCases:[{input:`1`,expectedOutput:`1`,output:`1`,score:10,hidden:!1},{input:`5`,expectedOutput:`8`,output:`8`,score:15,hidden:!1},{input:`10`,expectedOutput:`89`,output:`89`,score:20,hidden:!1},{input:`15`,expectedOutput:`987`,output:`987`,score:25,hidden:!1},{input:`20`,expectedOutput:`10946`,output:`10946`,score:30,hidden:!1}],starterXml:`<xml xmlns="https://developers.google.com/blockly/xml">
  <variables>
    <variable id="var_n">N</variable>
