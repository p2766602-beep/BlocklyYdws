...
</xml>`},{id:`A-01-1`,title:`一起學習吧`,description:`在程式設計的第一步，最重要的是能夠讀取使用者輸入，並將結果正確輸出。
...
</xml>`},{id:`A-02-0`,title:`數字加總`,description:`當我們要處理數字時，常常需要加總。
...
</xml>`},{id:`A-02-1`,title:`數字平均`,description:`當我們要處理數字時，常常需計算平均。
...
</xml>`},{id:`A-03-0`,title:`比較大小`,description:`在生活中常常會需要比較兩個數字誰比較大。

請寫一個程式，輸入兩個整數，輸出較大的數字。

如果兩個數字相同，就輸出「一樣大」。

這樣的練習可以訓練你使用條件判斷。`,inputDescription:``,outputDescription:``,requiresGreenFlag:!0,examples:[{input:`8
...
21`,expectedOutput:`一樣大`,output:`一樣大`,score:10}],difficulty:`L1`,difficultyLabel:`L1｜基礎`,starterXml:`<xml xmlns="https://developers.google.com/blockly/xml">
  <variables>
    <variable id="var_a">數字一</variable>
    <variable id="var_b">數字二</variable>
  </variables>
...
</xml>`},{id:`A-03-1`,title:`臺斤公斤大PK`,description:`在生活中常常會需要比較重量，台灣常見的單位有台斤、公斤，一台斤等於0.6公斤
...
這樣的練習可以訓練你使用條件判斷。`,inputDescription:``,outputDescription:``,requiresGreenFlag:!0,examples:[{input:`10
