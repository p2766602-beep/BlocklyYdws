var e={code:`M3-00-BinarySearchWarmup`,title:`二分搜尋入門暖身`,type:`programming`,mode:`learning`,tier:`t3`,tasks:[{id:`M3-00-01`,title:`神祕數字找找看`,description:`老師心中把候選數字由小到大排好，請你判斷某個目標數字在不在清單裡。
...
如果目標數字有在清單裡，輸出「找到了」；否則輸出「沒找到」。`,inputDescription:`N、已排序的N個數字、目標數字`,outputDescription:`找到了 或 沒找到`,examples:[{input:`5
2 4 6 8 10
...
1 3 5 7 9 11
11`,expectedOutput:`找到了`,output:`找到了`,score:20}],difficulty:`L2`,difficultyLabel:`L2｜進階`,starterXml:`<xml xmlns="https://developers.google.com/blockly/xml">
  <variables>
...
</xml>`},{id:`M3-00-02`,title:`神祕數字在第幾個`,description:`承接上一題，這次清單中的數字一樣由小到大排好。請你找出目標數字在清單中的位置（從第1個算起）。
...
如果找到，輸出目標數字的位置（從1開始算）；如果清單裡沒有這個數字，輸出0。`,inputDescription:`N、已排序的N個數字、目標數字`,outputDescription:`位置（1起始）或0（找不到）`,examples:[{input:`5
2 4 6 8 10
...
1 3 5 7 9 11
11`,expectedOutput:`6`,output:`6`,score:20}],difficulty:`L2`,difficultyLabel:`L2｜進階`,starterXml:``},{id:`M3-00-03`,title:`猜數字裁判`,description:`模擬猜數字遊戲的裁判：給一個正確答案secret，跟一串依序猜測的數字。請你算出玩家是第幾次才猜中（保證猜測序列裡一定會猜中一次）。
...
輸出玩家第幾次猜中（從第1次算起）。`,inputDescription:`secret、M、M個猜測值`,outputDescription:`第幾次猜中`,examples:[{input:`42
5
...
1
1`,expectedOutput:`1`,output:`1`,score:20}],difficulty:`L3`,difficultyLabel:`L3｜挑戰`,starterXml:``},{id:`M3-00-04`,title:`新書該插第幾格`,description:`書架上的書已經依照編號由小到大排好。請你決定新書該插入第幾個位置（從第1個算起），插入後書架仍維持由小到大排序。如果新書編號跟書架上已有的編號重複，新書要插在第一個相同編號的前面。
...
輸出新書應該插入的位置。`,inputDescription:`N、已排序的N個書本編號、新書編號`,outputDescription:`插入位置（1起始）`,examples:[{input:`5
10 20 30 40 50
...
1 3 3 3 7 9
3`,expectedOutput:`2`,output:`2`,score:16}],difficulty:`L3`,difficultyLabel:`L3｜挑戰`,starterXml:``},{id:`M3-00-05`,title:`訂單一次查`,description:`已排序的會員編號清單，請你一次查詢多筆會員編號是否存在。
第一行輸入N，代表會員總數
第二行輸入N個已排序的會員編號
第三行輸入Q，代表要查詢的筆數
第四行輸入Q個要查詢的編號，空白分隔
依查詢順序，依序輸出每筆查詢的結果「有」或「無」，用空白分隔成一行。`,inputDescription:`N、已排序的N個會員編號、Q、Q個查詢編號`,outputDescription:`依序輸出「有」或「無」，空白分隔`,examples:[{input:`5
3 8 15 22 30
3
...
2 4 6 8 10 12
4
1 4 13 12`,expectedOutput:`無 有 無 有`,output:`無 有 無 有`,score:25}],difficulty:`L3`,difficultyLabel:`L3｜挑戰`,starterXml:``},{id:`M3-00-06`,title:`打折門檻落點`,description:`店家依消費金額設定折扣門檻（門檻清單由小到大排序），請你判斷某筆消費金額達到第幾個門檻（即金額大於等於的最大門檻編號）。如果金額沒有達到任何門檻，輸出0。
...
輸出達到的門檻編號。`,inputDescription:`N、已排序的N個門檻金額、消費金額`,outputDescription:`達到的門檻編號，都沒達到輸出0`,examples:[{input:`3
500 1000 2000
...
100 200 300 400
99`,expectedOutput:`0`,output:`0`,score:16}],difficulty:`L3`,difficultyLabel:`L3｜挑戰`,starterXml:``}]};export{e as default};