var e={code:`114TCPE10`,title:`114-臺中市國小（競賽模式）`,type:`programming`,mode:`contest`,description:`臺中市114學年度國小組資訊科技教育競賽題庫`,source:{project:`YDWS-CodingBank`,generatedAt:`2026-08-07T11:01:54.415Z`,sourceCsv:`data/problem_bank_master_complete.csv`,problemSetTitle:`114-臺中市國小`,version:`manual-transcription-verified`,convertedFrom:`114ETaichung`,convertedAt:`2026-08-13T00:39:19.953Z`,note:`競賽模式版本：由對應學習模式課程複製轉換而來（原課程仍以學習模式繼續上架，互不影響）。starterXml已清空，測資正確答案僅保留在這份canonical檔案與各平台Worker的私密answerKeys.json，兩平台公開JS檔案已移除。`},tasks:[{id:`114TCPE10-1`,title:`以禮相待`,problemTitle:`以禮相待`,courseCode:`114TCPE10`,courseName:`114-臺中市國小（競賽模式）`,role:`contest`,difficulty:`L2`,blocklyFit:`高`,requiresGreenFlag:!0,description:`蘇洵為避免兩個兒子蘇軾、蘇轍彼此對中發票吵架，於是訂定了他們家的規則：
...
500`,score:10,hidden:!1},{input:`400
200`,score:10,hidden:!1},{input:`100
200`,score:10,hidden:!1},{input:`50
250`,score:10,hidden:!1},{input:`300
300`,score:10,hidden:!1}],starterXml:``,review:{needsManualReview:!1,risk:`低`,flags:[],note:`單純的扣除、比較大小與條件分支，沒有迴圈或清單，適合作為基礎練習題。`,exportDecision:`Claude 依使用者提供的臺中市114學年度國小組資訊科技教育競賽PDF手動轉錄並驗證`},tags:{mainConcepts:[`條件判斷`],subConcepts:[`四則運算`],algorithm:[`模擬`],dataStructure:[`變數`],syntax:[`if`,`比較運算`,`四則運算`],math:[],context:[`生活情境`,`金錢計算`]},restrictions:{requiredBlocks:[],disabledBlocks:[]}},{id:`114TCPE10-2`,title:`統一發票`,problemTitle:`統一發票`,courseCode:`114TCPE10`,courseName:`114-臺中市國小（競賽模式）`,role:`contest`,difficulty:`L3`,blocklyFit:`高`,requiresGreenFlag:!0,description:`蘇家父子三人拿著統一發票滿懷期待的兌獎，兌獎的規則如下：
...
若輸入不是 8 碼數字，輸出「非統一編號」。`},examples:[{input:`47887495`,output:`無中獎`,explanation:`號碼末幾碼都沒有跟任何頭獎號碼相同。`},{input:`451232`,output:`非統一編號`,explanation:`輸入只有 6 碼，不符合 8 碼發票的規範。`},{input:`25834483`,output:`特別獎`,explanation:`與特別獎號碼完全相同。`}],testCases:[{input:`47887495`,score:10,hidden:!1},{input:`451232`,score:10,hidden:!1},{input:`25834483`,score:10,hidden:!1},{input:`46587380`,score:10,hidden:!1},{input:`41016094`,score:10,hidden:!1},{input:`00007261`,score:10,hidden:!1}],starterXml:``,review:{needsManualReview:!1,risk:`低`,flags:[],note:`需要處理字串長度檢查與末幾碼比對，並依比對到的最長碼數決定獎項，邏輯層次較多。`,exportDecision:`Claude 依使用者提供的臺中市114學年度國小組資訊科技教育競賽PDF手動轉錄並驗證`},tags:{mainConcepts:[`字串處理`],subConcepts:[`條件判斷`],algorithm:[`字串比對`],dataStructure:[`字串`],syntax:[`if`,`字串長度`,`取子字串`,`比較運算`],math:[],context:[`生活情境`,`統一發票`]},restrictions:{requiredBlocks:[],disabledBlocks:[]}},{id:`114TCPE10-3`,title:`閃電十一人`,problemTitle:`閃電十一人`,courseCode:`114TCPE10`,courseName:`114-臺中市國小（競賽模式）`,role:`contest`,difficulty:`L3`,blocklyFit:`高`,requiresGreenFlag:!0,description:`小明承辦了校際足球賽，需要一套自動計分與判定系統。每一場比賽只有兩隊，且只會發生兩種事情：進球 Goal、犯規 Foul。
規則：
進 1 球即得 1 分。
每犯規 3 次，該隊扣 1 分。
扣分不會讓分數低於 0 分。
...
FB
FB
GB`,score:10,hidden:!1},{input:`6
GA
GB
FA
FA
FA
GB`,score:10,hidden:!1},{input:`4
GA
GB
FA
FB`,score:10,hidden:!1},{input:`9
FA
FA
FA
FA
...
FA
FA
FA`,score:10,hidden:!1}],starterXml:``,review:{needsManualReview:!1,risk:`低`,flags:[],note:`需要用迴圈逐行讀取事件、用變數累計兩隊得分與犯規次數，並用整數除法換算扣分，是基礎的模擬類型題。`,exportDecision:`Claude 依使用者提供的臺中市114學年度國小組資訊科技教育競賽PDF手動轉錄並驗證`},tags:{mainConcepts:[`模擬與狀態更新`],subConcepts:[`迴圈與累計`],algorithm:[`模擬`],dataStructure:[`變數`],syntax:[`for`,`if`,`字串比較`,`整數除法`],math:[],context:[`生活情境`,`球類比賽`]},restrictions:{requiredBlocks:[],disabledBlocks:[]}},{id:`114TCPE10-4`,title:`紅牌與黃牌`,problemTitle:`紅牌與黃牌`,courseCode:`114TCPE10`,courseName:`114-臺中市國小（競賽模式）`,role:`contest`,difficulty:`L4`,blocklyFit:`高`,requiresGreenFlag:!0,description:`延續閃電十一人的基本規則（進球得分、每犯規 3 次扣 1 分、分數不低於 0），新增以下規則：
每犯規 2 次，該隊得 1 張黃牌。
...
FA
FA
GB`,score:10,hidden:!1},{input:`5
GA
FA
FA
GB
FB`,score:10,hidden:!1},{input:`8
GA
GA
FA
FA
