...
• 輸出一個整數，代表所有寶可夢等級的平均值（無條件捨去）。`,inputDescription:``,outputDescription:``,requiresGreenFlag:!0,examples:[{input:`4
...
程式依照輸入出現順序，輸出所有等級高於平均值的寶可夢名稱。`,inputDescription:``,outputDescription:``,requiresGreenFlag:!0,examples:[{input:`3
...
若屬性重複，只輸出一次。`,inputDescription:``,outputDescription:``,requiresGreenFlag:!0,examples:[{input:`5
...
(說明：第三行的第 i 個數字與第四行的第 i 個數字代表一條連接的走道。例如：第三行是 1 2 3，第四行是 2 3 4，代表連接為 1-2、2-3、3-4)`,outputDescription:`一個整數 (最熱門路口編號)。`,requiresGreenFlag:!0,examples:[{input:`3
2
1 1
...
• 所有數字之間皆以單一空白隔開。`,outputDescription:`• 請輸出一個整數，代表探測車在 100 單位電力限制下，可獲得的最高總科學價值。`,requiresGreenFlag:!0,examples:[{input:`3
