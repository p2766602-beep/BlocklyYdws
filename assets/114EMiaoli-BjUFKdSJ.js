var e={code:`114EMiaoli`,title:`114-苗栗縣國小`,type:`programming`,mode:`learning`,description:`114-苗栗縣國小114學年度科技教育創意實作競賽題庫`,source:{project:`YDWS-CodingBank`,generatedAt:`2026-08-31T12:29:59.247Z`,sourceTxt:`txtFile/114EMiaoli.txt`,version:`manual-blockly-build-verified`},tasks:[{id:`114EMiaoli-1`,title:`1-苗栗項鍊`,problemTitle:`1-苗栗項鍊`,courseCode:`114EMiaoli`,courseName:`114-苗栗縣國小`,role:`contest`,difficulty:`L2`,blocklyFit:`中`,description:`苗栗縣政府決定發放由英文字母M與L珠子串連的項鍊給市民作紀念。由於每個人需要的尺寸不同，尺寸1的項鍊表示英文字母M與L珠子各一顆，形成字串ML 尺寸2的項鍊表示英文字母M與L珠子各二顆，也就會形成字串MLML。尺寸更大的項鍊，就會形成重複該次數的字串ML。
請使用 Scratch3撰寫一個程式專案，根據項鍊的尺寸，幫忙印出項鍊的珠子形成的字串。
【輸入格式】
「詢問...並等待」一次後，這次「詢問的答案」會得到：項鍊的尺寸。(1~100)
【輸出格式】
回答恰好一次，請回答項鍊的珠子形成的字串，中間不可以有空格或任何其他符號。(僅需輸出該字串)。`,inputDescription:``,outputDescription:``,statement:{description:`苗栗縣政府決定發放由英文字母M與L珠子串連的項鍊給市民作紀念。由於每個人需要的尺寸不同，尺寸1的項鍊表示英文字母M與L珠子各一顆，形成字串ML 尺寸2的項鍊表示英文字母M與L珠子各二顆，也就會形成字串MLML。尺寸更大的項鍊，就會形成重複該次數的字串ML。
請使用 Scratch3撰寫一個程式專案，根據項鍊的尺寸，幫忙印出項鍊的珠子形成的字串。
【輸入格式】
「詢問...並等待」一次後，這次「詢問的答案」會得到：項鍊的尺寸。(1~100)
【輸出格式】
回答恰好一次，請回答項鍊的珠子形成的字串，中間不可以有空格或任何其他符號。(僅需輸出該字串)。`,input:``,output:``},examples:[{input:`1`,output:`ML`,explanation:`程式詢問一次，得到回答1。
答案是字串ML，所以用「說出」積木回答說出ML。`},{input:`2`,output:`MLML`,explanation:`程式詢問一次，得到回答2。
答案是字串 MLML，所以用「說出」積木回答，說出 MLML。`},{input:`5`,output:`MLMLMLMLML`,explanation:`程式詢問一次，得到回答5。
答案是字串 MLMLMLMLML，所以用「說出」積木回答，說出 MLMLMLMLML。`}],starterXml:`<xml xmlns="https://developers.google.com/blockly/xml"><variables><variable id="e1_n">N</variable><variable id="e1_i">i</variable><variable id="e1_out">out</variable></variables><block type="event_whenflagclicked" x="40" y="40"><next><block type="interaction_ask_and_wait"><value name="TEXT"><block type="text"><field name="TEXT">請輸入項鍊尺寸N</field></block></value><next><block type="variables_set"><field name="VAR" id="e1_n">N</field><value name="VALUE"><block type="interaction_answer"></block></value><next><block type="variables_set"><field name="VAR" id="e1_out">out</field><value name="VALUE"><block type="text"><field name="TEXT"></field></block></value><next><block type="controls_for"><field name="VAR" id="e1_i">i</field><value name="FROM"><block type="math_number"><field name="NUM">1</field></block></value><value name="TO"><block type="variables_get"><field name="VAR" id="e1_n">N</field></block></value><value name="BY"><block type="math_number"><field name="NUM">1</field></block></value><statement name="DO"><block type="variables_set"><field name="VAR" id="e1_out">out</field><value name="VALUE"><block type="text_join"><mutation items="2"></mutation><value name="ADD0"><block type="variables_get"><field name="VAR" id="e1_out">out</field></block></value><value name="ADD1"><block type="text"><field name="TEXT">ML</field></block></value></block></value></block></statement><next><block type="interaction_say"><value name="TEXT"><block type="variables_get"><field name="VAR" id="e1_out">out</field></block></value></block></next></block></next></block></next></block></next></block></next></block></xml>`,testCases:[{input:`1`,expectedOutput:`ML`,score:10},{input:`2`,expectedOutput:`MLML`,score:10},{input:`5`,expectedOutput:`MLMLMLMLML`,score:10},{input:`3`,expectedOutput:`MLMLML`,score:10},{input:`4`,expectedOutput:`MLMLMLML`,score:10},{input:`10`,expectedOutput:`MLMLMLMLMLMLMLMLMLML`,score:10},{input:`6`,expectedOutput:`MLMLMLMLMLML`,score:10},{input:`7`,expectedOutput:`MLMLMLMLMLMLML`,score:10},{input:`8`,expectedOutput:`MLMLMLMLMLMLMLML`,score:10},{input:`9`,expectedOutput:`MLMLMLMLMLMLMLMLML`,score:10}]},{id:`114EMiaoli-2`,title:`2-點名報數`,problemTitle:`2-點名報數`,courseCode:`114EMiaoli`,courseName:`114-苗栗縣國小`,role:`contest`,difficulty:`L2`,blocklyFit:`中`,description:`期待已久的寒假終於快要開始了！但是今天班上有一個同學沒有來上學考試，也沒有請假。老師迷迷糊糊，已經分不清楚是誰沒來了，於是決定請大家點名報數，這樣就能知道是誰沒有來。
...
【輸出格式】
回答恰好一次，「說出」沒有來上學考試的座號。(僅需輸出該座號)。`,inputDescription:``,outputDescription:``,statement:{description:`期待已久的寒假終於快要開始了！但是今天班上有一個同學沒有來上學考試，也沒有請假。老師迷迷糊糊，已經分不清楚是誰沒來了，於是決定請大家點名報數，這樣就能知道是誰沒有來。
這個班級的座號從1開始，依照1,2,3,... 順序編下去，中間不會有跳號，直到最後一號，也就是班級的總人數。大家會依照自己的座號順序，依照從小到大的順序報數。舉例來說，如果總共有5個學生，點名報數時，報的座號是1,2,4,5，那麼老師就知道座號3的同學沒有來。請使用Scratch撰寫一個程式專案，根據所有學生從小到大的順序報數，幫老師找出是誰沒有來上學考試。
【輸入格式】
「詢問...並等待」一次後，這次「詢問的答案」會得到：班級的總人數。(2~20人)
接著繼續使用「詢問...並等待」取得依照從小到大的順序每次報數，次數比「班級的總人數」少一次：
...
4
5
6`,expectedOutput:`2`,score:10},{input:`7
1
2
3
4
6
7`,expectedOutput:`5`,score:10},{input:`2
...
5
6
8`,expectedOutput:`7`,score:10},{input:`9
1
2
3
4
...
6
7
8`,expectedOutput:`9`,score:10},{input:`10
1
2
3
4
...
8
9
10`,expectedOutput:`7`,score:10}]},{id:`114EMiaoli-3`,title:`3-最大人數`,problemTitle:`3-最大人數`,courseCode:`114EMiaoli`,courseName:`114-苗栗縣國小`,role:`contest`,difficulty:`L2`,blocklyFit:`中`,description:`在一個偌大的禮堂中，人潮進進出出參觀展覽。為了安全起見，老師指派一個學生守著出入口，每當有人進入或離開，就記錄下來，這樣就可以從記錄中，得到在禮堂人數最多時，禮堂中總共有多少人。
...
• 紙上只會有英文字母A與B。
【輸出格式】
總共回答恰好一次，請輸出禮堂最多人時總共有多少人，「說出」禮堂中最多的人數。(僅需輸出數字)。`,inputDescription:``,outputDescription:``,statement:{description:`在一個偌大的禮堂中，人潮進進出出參觀展覽。為了安全起見，老師指派一個學生守著出入口，每當有人進入或離開，就記錄下來，這樣就可以從記錄中，得到在禮堂人數最多時，禮堂中總共有多少人。
禮堂一開始沒有人，每當有人進入時，這位學生就會在紙上多寫下英文字母A；每當有人離開時，這位學生就會在紙上多寫下英文字母B。這張紙上的字母一定會依照順序寫下，不會被擦除。除此之外，紙上不會有其他的東西。
舉例來說，如果現在紙上寫著AAABABBB，那麼老師就可以知道：現在禮堂中沒有人，且在最多人時總共有3個人；另外，如果現在紙上寫著ABAB，那麼老師就可以知道現在禮堂中沒有人，且在最多人時總共有1個人。
負責記錄的學生非常乖，因此記錄下來的資料一定正確，且最終進入禮堂的所有人都會離開。
【輸入格式】
...
【輸出格式】
回答一次，請「說出」最多可以組成多少組。(僅需輸出數字)。`,inputDescription:``,outputDescription:``,statement:{description:`班上有男生與女生，現在要組隊跳健康操，每一組兩個人，一男一女，且這兩個人的身高必須相同。已知男生與女生的身高都已經各自從小到大排好，請使用Scratch3撰寫一個程式專案，根據每一位男生與女生的身高，幫忙求出最多可以組成多少組。
每個人最多同時只能在一組中，但也可能沒有被分組。
【輸入格式】
先詢問男生的部分：
「詢問...並等待」一次後，這次「詢問的答案」會得到：男生的人數。(1~100人)
...
140
150
160`,expectedOutput:`3`,score:10},{input:`4
100
110
120
130
...
150
160
170`,expectedOutput:`0`,score:10},{input:`3
150
150
150
2
150
150`,expectedOutput:`2`,score:10},{input:`2
130
130
4
130
130
130
130`,expectedOutput:`2`,score:10},{input:`5
110
120
130
140
...
140
150
160`,expectedOutput:`4`,score:10},{input:`1
100
2
110
120`,expectedOutput:`0`,score:10},{input:`2
150
160
1
160`,expectedOutput:`1`,score:10},{input:`3
140
140
150
3
140
150
150`,expectedOutput:`2`,score:10}]},{id:`114EMiaoli-5`,title:`5-進位運算`,problemTitle:`5-進位運算`,courseCode:`114EMiaoli`,courseName:`114-苗栗縣國小`,role:`contest`,difficulty:`L2`,blocklyFit:`中`,description:`數學老師發現大家算數時常常粗心大意，連基本的加減法都不太熟...於是老師決定出一大堆加法的練習題給大家來練習，由於總是有偷懶的學生使用計算機幫忙算，這樣就沒有練習到了，所以老師要求只需要回答進行加法運算中，發生進位的次數。
...
【輸出格式】
回答恰好一次，「說出」總共發生幾次進位。(僅需輸出數字)。`,inputDescription:``,outputDescription:``,statement:{description:`數學老師發現大家算數時常常粗心大意，連基本的加減法都不太熟...於是老師決定出一大堆加法的練習題給大家來練習，由於總是有偷懶的學生使用計算機幫忙算，這樣就沒有練習到了，所以老師要求只需要回答進行加法運算中，發生進位的次數。
在十進位的直式加法中，依位數由低位到高位逐位相加。若某一位上「本位相加的和(包含上一位帶來的進位)」大於或等於10，則在本位寫下該和的個位數，並把1加到左邊相鄰的高一位(也就是把10個本位合成1個高一位)。這個「把1送到高一位」的處理，稱為「進位」。
「進位的次數」定義為：在完成整個直式加法的計算過程中，因為某一位的相加結果(包含上一位的進位)大於或等於10，而產生「向左邊高一位送出1」之動作的總次數。每一個位數只要實際產生一次進位，就計為1次；若連續多位都各自產生進位，則每一位產生的進位都要分別計次。
舉例來說，當計算999加1時，總共發生了3次進位；而計算1998加37時，總共也發生了3次進位；但是計算2008加17時，總共只發生了1次進位。
【輸入格式】
