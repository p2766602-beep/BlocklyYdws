...
若 S 小於 60，不輸出。`,examples:[{input:`75`,output:`Pass`,explanation:`75 大於等於 60，所以輸出 Pass。`},{input:`40`,output:``,explanation:`40 小於 60，所以不輸出任何文字。`}],testCases:[{input:`60`,expectedOutput:`Pass`,output:`Pass`,score:20},{input:`59`,expectedOutput:``,output:``,score:20},{input:`100`,expectedOutput:`Pass`,output:`Pass`,score:20},{input:`0`,expectedOutput:``,output:``,score:20},{input:`75`,expectedOutput:`Pass`,output:`Pass`,score:20}],difficulty:`L1`,difficultyLabel:`L1｜基礎`,starterXml:``},{id:`JSB02-D02`,title:`優惠或原價`,description:`商店規定消費金額達到 100 元以上可以獲得優惠。請輸入消費金額，如果金額大於或等於 100，輸出 Discount；否則輸出 Normal。本題用來示範 if / else 的二選一流程。
輸入格式：
第一行：一個整數 M，代表消費金額。
輸出格式：
...
這樣的練習可以幫助你熟悉條件判斷的應用。`,inputDescription:``,outputDescription:``,examples:[{input:`8`,output:`Even`,explanation:`輸入8，8除以2餘數=0
...
第一行：一個整數 S，代表成績。
輸出格式：
輸出一個英文字母，代表成績等第。`,inputDescription:`第一行：一個整數 S，代表成績。`,outputDescription:`輸出一個英文字母，代表成績等第。`,examples:[{input:`95`,output:`A`,explanation:`95 分屬於 A。`},{input:`72`,output:`C`,explanation:`72 分屬於 C。`}],testCases:[{input:`90`,expectedOutput:`A`,output:`A`,score:20},{input:`89`,expectedOutput:`B`,output:`B`,score:20},{input:`70`,expectedOutput:`C`,output:`C`,score:20},{input:`60`,expectedOutput:`D`,output:`D`,score:20},{input:`59`,expectedOutput:`F`,output:`F`,score:20}],difficulty:`L2`,difficultyLabel:`L2｜進階`,starterXml:``},{id:`A-04-1`,title:`成績等第`,description:`不少學校成績採用等弟制，80~100為A，70~79為B，60~69為C，50~59為D，其餘49分以下為E

請你寫一個程式，輸入一個整數(0~100)，輸出對應的成績等弟。

這樣的練習可以幫助你熟悉條件判斷的應用。`,inputDescription:``,outputDescription:``,examples:[{input:`90`,output:`A`,explanation:`輸入90，表示成績90
...
程式最後輸出 定價加總總額、售價加總總額、優惠多少元`,inputDescription:``,outputDescription:``,examples:[{input:`3
80 70 90`,output:`240
215
...
身高（公分）、年齡（歲）、縣民卡（1 表示有，0 表示無），資料間以空白分隔。`,outputDescription:`輸出一個整數，代表這一團遊客的門票總金額。`,examples:[{input:`2
...
第二行輸入 N 個整數（0～10），代表每位評審給的分數，資料間以空白隔開。`,outputDescription:`輸出一個整數，代表去除最高分與最低分後的總成績。`,examples:[{input:`5
...
程式需計算並輸出此次訂單的總金額。`,inputDescription:``,outputDescription:``,examples:[{input:`3
...
•付款不足：總金額X 付款不足Y`,inputDescription:``,outputDescription:``,examples:[{input:`2
5 2 4 3
