...
</xml>`},{id:`count-010`,title:`能量水晶融合`,description:`勇者正在合成一顆能量水晶。這顆水晶的能量是不斷相乘的！
第 1 階段能量為 1。
第 2 階段能量變成 1 * 2。
第 3 階段能量變成 1 * 2 * 3。
請問到了第 N 階段，能量總共有多少？
...
</xml>`},{id:`count-011`,title:`修復斷橋`,description:`勇者需要修復一座斷掉的橋。橋的每一段需要的木材數量等於該段的編號。
...
</xml>`},{id:`count-014`,title:`戰利品清點`,description:`勇者打敗了一群史萊姆，每隻史萊姆身上掉落的金幣數量都不一樣。 助手已經把每隻史萊姆掉落的金幣數量記在清單上了。 請你幫勇者算算看，這次戰鬥總共獲得了多少金幣？
輸入格式
...
1 1 1 1 1 1 1 1 1`,expectedOutput:`9`,output:`9`,score:10}],difficulty:`L2`,difficultyLabel:`L2｜進階`,starterXml:`<xml xmlns="https://developers.google.com/blockly/xml">
  <variables>
...
</xml>`},{id:`count-015`,title:`尋找戰鬥力最高的魔王`,description:`偵查兵帶回了一份情報，上面記錄了前方 N 隻怪物的戰鬥力數值。
勇者想要先挑戰最強的那一隻！
...
25 45 95 12 55`,expectedOutput:`95`,output:`95`,score:10}],difficulty:`L2`,difficultyLabel:`L2｜進階`,starterXml:`<xml xmlns="https://developers.google.com/blockly/xml">
  <variables>
...
</xml>`},{id:`count-012`,title:`登山冒險`,description:`這是一題大魔王關卡！勇者要爬一座高山，然後再下山。
