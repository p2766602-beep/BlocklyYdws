...
輸出爬到第N階的方法數。`,inputDescription:`N`,outputDescription:`爬法總數`,examples:[{input:`5`,output:`8`,explanation:`第5階的方法數=第4階方法數+第3階方法數=5+3=8`}],testCases:[{input:`1`,expectedOutput:`1`,output:`1`,score:25},{input:`2`,expectedOutput:`2`,output:`2`,score:25},{input:`5`,expectedOutput:`8`,output:`8`,score:25},{input:`8`,expectedOutput:`34`,output:`34`,score:25}],difficulty:`L2`,difficultyLabel:`L2｜進階`,starterXml:``},{id:`M3-04-02`,title:`最小花費爬樓梯`,description:`每一階樓梯都有一個花費，你可以選擇從第1階或第2階開始爬（不用付出發那階的費用以外的額外代價），每次可以往上爬1階或2階，最終目標是離開樓梯（爬過最後一階或倒數第二階再跨一步出去都算離開）。請問離開樓梯最少要花多少錢？

第一行輸入N，代表共有N階樓梯

第二行輸入N個數字，代表第1階到第N階（由1開始編號）各自的花費

輸出離開樓梯的最小花費。`,inputDescription:`N、N個花費數字`,outputDescription:`最小花費`,examples:[{input:`3
...
輸出可以選出的最大總和。`,inputDescription:`N、N個數字`,outputDescription:`最大總和`,examples:[{input:`5
...
輸出最少需要的硬幣枚數。`,inputDescription:`K、K個硬幣面額、amount`,outputDescription:`最少硬幣枚數`,examples:[{input:`3
1 5 10
