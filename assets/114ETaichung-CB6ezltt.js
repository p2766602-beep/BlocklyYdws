...
300`,expectedOutput:`無盈餘`,output:`無盈餘`,score:10,hidden:!1}],starterXml:``,review:{needsManualReview:!1,risk:`低`,flags:[],note:`單純的扣除、比較大小與條件分支，沒有迴圈或清單，適合作為基礎練習題。`,exportDecision:`Claude 依使用者提供的臺中市114學年度國小組資訊科技教育競賽PDF手動轉錄並驗證`},tags:{mainConcepts:[`條件判斷`],subConcepts:[`四則運算`],algorithm:[`模擬`],dataStructure:[`變數`],syntax:[`if`,`比較運算`,`四則運算`],math:[],context:[`生活情境`,`金錢計算`]},restrictions:{requiredBlocks:[],disabledBlocks:[]}},{id:`114ETaichung-2`,title:`統一發票`,problemTitle:`統一發票`,courseCode:`114ETaichung`,courseName:`114-臺中市國小`,role:`contest`,difficulty:`L3`,blocklyFit:`高`,requiresGreenFlag:!0,description:`蘇家父子三人拿著統一發票滿懷期待的兌獎，兌獎的規則如下：
