var e={code:`114JYunlin`,title:`114-雲林縣國中`,type:`programming`,mode:`learning`,description:`114-雲林縣國中114學年度科技教育創意實作競賽題庫`,source:{project:`YDWS-CodingBank`,generatedAt:`2026-08-18T10:12:38.973Z`,sourceTxt:`txtFile/114JYunlin.txt`,version:`manual-blockly-build-verified`,note:`2026-08批次修正：原5題被誤植為與114JChaiyiC（嘉義縣）幾乎完全重複的內容（txtFile源頭複製錯，非本平台轉換流程造成），經使用者提供正確txtFile重新製作，starterXml皆用headless Blockly harness（verify.mjs）驗證100%通過。`},tasks:[{id:`114JYunlin-1`,title:`1-秒數轉換`,problemTitle:`1-秒數轉換`,courseCode:`114JYunlin`,courseName:`114-雲林縣國中`,role:`contest`,difficulty:`L1`,blocklyFit:`高`,description:`體育課跑步計時器會記錄「總秒數」，但老師希望顯示成「幾分幾秒」的格式。
請輸入一個整數，代表「總秒數」。
再將其轉換為：
• X 分鐘數（整數）
• Y 剩餘秒數
...
1.6`,expectedOutput:`肥胖`,score:10}]},{id:`114JYunlin-4`,title:`4-成績統計`,problemTitle:`4-成績統計`,courseCode:`114JYunlin`,courseName:`114-雲林縣國中`,role:`contest`,difficulty:`L2`,blocklyFit:`高`,description:`老師要統計班上這次月考的成績情形。
...
10 20 30 40 50`,expectedOutput:`30 2`,score:10}]},{id:`114JYunlin-5`,title:`5-手機電量充電模擬`,problemTitle:`5-手機電量充電模擬`,courseCode:`114JYunlin`,courseName:`114-雲林縣國中`,role:`contest`,difficulty:`L1`,blocklyFit:`高`,description:`小華的手機目前電量為 B%。
他將手機接上充電器，充電速度如下：
• 每分鐘增加 2% 電量
• 最高只能充到 100%
請輸入兩個整數：
