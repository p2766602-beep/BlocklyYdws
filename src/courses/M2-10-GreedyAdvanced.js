  ...
  "tasks": [
    {
      ...
      "inputDescription": "• 系統的第一個輸入包含兩個整數 K 與 N（1 ≤ K, N ≤ 100），K 代表簽唱會人數上限，N 代表報名粉絲總數。\n\n• 系統的第二個輸入包含 N 個整數，依序代表這 N 位粉絲的積分（0 ≤ 積分 ≤ 100）。\n\n• 所有數字之間皆以單一空白隔開。",
      "outputDescription": "• 請依據報名順序，輸出獲得邀請的粉絲「報名編號（從 1 開始計數）」，編號需由小到大排列，中間以單一空白隔開。\n\n• 若無法發出任何邀請函，則輸出 0。",
      "examples": [
        {
          "input": "3 6\n90 95 80 95 70 60",
          "output": "1 2 4",
    ...
    },
    {
      ...
      "inputDescription": "第一行：一個整數 N，代表貨物數量。\n\n第二行：N個整數，各件貨物重重量Wi\n\n第三行：一個整數 W，代表代表目標配重 W>0",
      "outputDescription": "第一行：一個字串 YES 或 NO",
      "examples": [
        {
          "input": "3\n10 20 30\n50",
          "output": "YES",
    ...
    },
    {
      ...
      "inputDescription": "• 第一行輸入一個整數 N，代表購買的商品種類數。\n\n• 接下來輸入 N 組資料，每組包含兩個整數 Q 與 P，\n\n  分別代表商品的數量與單價，資料間以空白隔開。",
      "outputDescription": "• 依照輸入順序，輸出 N 個整數。\n\n• 每個整數代表當下計算完成後的累積總金額。\n\n• 數字之間以一個半形空格隔開。",
      "examples": [
        {
          "input": "2\n3 10 2 50",
          "output": "30 130",
      ...
      "testCases": [
        ...
        },
        {
          ...
          "output": "1000 2000 2600 3000 4500",
          "score": 30
        }
      ],
      "difficulty": "L4",
    ...
    },
    {
      ...
      "inputDescription": "• 第一行輸入一個整數 N，代表營運的小時數。\n\n• 接下來輸入 N 個整數，依序代表每小時新到達碼頭的旅客人數。",
      "outputDescription": "• 輸出一行共兩個整數：\n\n  1. 今日成功載運的旅客人數總和。\n\n  2. 今日發出的總船班數（固定航班 + 加班船）。\n\n• 兩個整數之間以一個半形空格隔開。",
      "examples": [
        {
          "input": "1\n220",
          "output": "220 2",
